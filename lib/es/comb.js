 ...
 */
export const heapPerm = (anyArray)=>{
 ...
 */
export const heapPermIterative = (anyArray)=>{
    let pointer = anyArray.length;
 ...
 */
export const combAll = (anyArray, direction='f')=>{
    let resultArray = [];
 ...
 */
export const combAllStrict = (anyArray, direction='f', length, strict)=>{
    let resultArray = [];
    //anyArray.length-1, num_of_combinations = 2^(anyArray.length-1)
    let arrLength = anyArray.length;
    let num_of_combinations = Math.pow(2, arrLength) - 1;   
